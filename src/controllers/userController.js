...
const login = async function (req, res) {
    try {
        ...
        if (password.length < 8 || password.length > 15) return res.status(400).send({ status: false, message: "Please send  8 to 15 length Alphanumeric with one Special Character Password" })
